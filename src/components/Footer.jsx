                ...
                <footer>
                    <div className='footerGlobalDescription d-flex flex-column align-items-center'>
                        ...
                        <div className="footerCopyright mt-4 w-75 text-center">
                            <h6>©2022 por Marili Réquia Corretora de Seguros
                                ...
                                autarquia vinculada ao Ministério da Fazenda, Órgão do governo brasileiro responsável pelo controle e fiscalização dos mercados de seguros.</h6>
                        </div>
                    </div>
